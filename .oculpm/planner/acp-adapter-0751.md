...
- [ ] `_meta.contextCompaction`(trigger·preTokens·postTokens·durationMs)을 읽어 압축을 일반 도구 카드가 아닌 제 모양으로 — 지금은 "Compact conversation" 이라는 think 도구로만 보여 몇 토큰이 줄었는지 알 수 없다 {#carry-compaction}
