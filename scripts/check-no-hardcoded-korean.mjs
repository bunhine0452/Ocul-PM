...
const TESTS = new Set([
  ...
  "__tests__/activity_classify.test.ts",
  "__tests__/activity_group.test.ts",
  "__tests__/activity_stream.test.tsx",
  ...
  "__tests__/file_size_ratchet.test.ts",
  ...
  "__tests__/plan_board.test.tsx",
  "__tests__/plan_body_upgrade.test.tsx",
  "__tests__/plan_hover_card.test.tsx",
  "__tests__/plan_list.test.ts",
  "__tests__/plan_meta.test.ts",
  ...
  // bug-hunt C4 (2026-09-22) — 시작 탭의 설정 오버레이. 한국어 테스트 이름뿐이다.
  "__tests__/settings_without_workspace.test.tsx",
  "__tests__/today_activity.test.tsx",
  "__tests__/today_journal_missing.test.tsx",
  "__tests__/today_plugin_dismiss.test.tsx",
  "__tests__/today_ring_scale.test.ts",
