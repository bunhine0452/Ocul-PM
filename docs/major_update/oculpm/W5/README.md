...
| 12 | DifficultyMix 도넛 슬라이스 클릭 → Today 의 difficulty 필터 | 🟡 PR5 intent push ✅ / consume PR6 / 수동 검증 PR8 | PR5 + W3 filter |
| 13 | AgentBreakdown 막대 클릭 → Today 의 agent 필터 | 🟡 PR5 intent push ✅ / consume PR6 / 수동 검증 PR8 | PR5 + PR6 |
