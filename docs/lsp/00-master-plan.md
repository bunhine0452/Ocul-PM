...
작성 2026-08-21 · 상태: **PR-LSP0~3 완료 · v2.15.0 로 출시** (2026-09-04 확인 — 원문은 "PR-LSP0 진행 중")
...
- **디버거(DAP)** — LSP 로 안 닫힌다. 에이전트가 코드를 쓰는 워크플로에서 인앱 디버거의
  ...
  > **뒤집힘 (2026-08-23 → v2.16.0 출시)** — "필요해지면 별도 결정" 이 그대로
  > 일어났다. 사용자가 요청했고 [`../dap/00-master-plan.md`](../dap/00-master-plan.md)
  > 가 결정을 다시 열었다. 구현은 `src-tauri/src/dap/` (Rust · Python · Go).
