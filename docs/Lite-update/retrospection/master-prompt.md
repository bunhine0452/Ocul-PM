...
### 5.1 현재 위치 (2026-05-30)

- **Phase A**: ✅ PR0 완료 / ✅ PR1 완료 (no-op + 회귀 lock — §5.3 참조)
- **Phase B**: ✅ PR2 ~ ✅ PR5 **모두 완료** — Phase B 종료
- **Phase C**: ✅ PR6 (6.1 1.1 로 연기 / 6.2~**6.5 모두 완료**) / ✅ PR7 (Part 1 + Part 2 모두 완료) / ✅ PR8 (Part 1~3 **모두 완료**) / ✅ PR9 완료 — **Phase C 종료**
...
진행 중 작업: *없음*. **PR10 + PR6.5 완전 종료** — 남은 단 하나의 PR 은 PR12 (빌드/서명/릴리스). Apple Developer ID 등 외부 dep / 환경 변수 / GitHub release 등 사용자 입력이 필요한 단계.
