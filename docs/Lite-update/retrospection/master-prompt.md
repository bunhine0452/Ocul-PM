...
- **Phase B**: ✅ PR2 완료 / ✅ PR3 완료 / ☐ PR4~PR5 미진입
- **Phase C**: ☐ PR6~PR9 미진입
- **Phase D**: ☐ PR10~PR12 미진입
- **추가**: ✅ PR-0c 완료 (clippy 48 errors → 0). `cargo clippy --all-targets -- -D warnings` 가 이제부터 진짜 lock.

진행 중 작업: *없음*. 다음 작업: **PR4 (SQLite Changelog 시스템 삭제)** — Phase B 의 가장 큰 schema cut.
