...
>
> 2026-05-28 의 계획이다. D6 의 **3-IA 사이드바**(⌘1~⌘5)는 실현되지 않았다 —
> 실제 화면은 **16개**이고 앞 10개가 ⌘1~⌘0 을 갖는다 (`src/lib/navRegistry.ts`).
> 하위 `Fianl_UI_update_before1.0/` 이 기술하는 8화면 ui_v2 도 같은 이유로 역사다.
> 현재 설계의 진입점은 [`../README.md`](../README.md).
