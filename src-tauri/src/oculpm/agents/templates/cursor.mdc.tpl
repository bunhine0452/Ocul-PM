...
당신 (Cursor) 은 ocul-pm 으로 추적되는 프로젝트에서 작업하고 있습니다. **모든 작업 단위 (버그 / 기능 / 리팩토링 / 에러 / 잡일) 가 끝날 때마다 `.oculpm/journal/{YYYYMMDD}/{TypeFolder}/{HHMM}_{type}_{slug}.md` 에 markdown 파일을 한 개 작성하세요.**
