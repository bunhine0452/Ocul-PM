  ...
  return (
    <div className="space-y-5 p-4">
      <div className="mob-hero px-4 py-3.5 flex items-baseline gap-3">
        ...
        <span className="text-fs-4 mob-text-2">{t("mobile.today.entries")}</span>
          ...
          <ul className="space-y-2">
            {updates.map((u, i) => (
              <li key={i} className="mob-card px-3.5 py-2.5">
                <div className="text-fs-4 font-medium">{u.item_title || u.item_id}</div>
                <div className="flex items-center gap-2 text-fs-2 mob-text-3 mt-1">
