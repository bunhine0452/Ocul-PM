...
// 코드 화면 파일 조작 (#file-ops-ui) — 새 파일 / 새 폴더. lucide file-plus·folder-plus.
...
export {
  ...
  Columns2,
  Rows2,
  // 터미널 드래그-분할 (2026-08-28) — 페인을 집는 손잡이.
  GripVertical,
  ...
  Palette,
  Upload,
  // 감사 라운드 2026-09-11 C1 — 「Notion 으로 보내기」(일지 상세 · 브랜치 요약).
  Send,
  ...
  Archive,
  // 세션 화면 (2026-09-04) — 묶기는 **점을 잇는 일**이다. 사람 아이콘(Users)을
