...
// OpenAI Codex 로고마크 (docs/codex.svg — 공식 마크를 그대로 옮긴 것).
//
// `ClaudeMark` 와 같은 계약을 지킨다: `currentColor` 로 채워 사이드바의 다른
// 아이콘들과 같은 색·같은 상태(활성/비활성)를 그냥 따라가고, `size` 를
// `number | string` 으로 받아 lucide 아이콘 자리에 어댑터 없이 끼워진다.
// 원본 SVG 를 그대로 쓰지 않은 이유도 같다 — 색을 못 물리면 혼자 스티커처럼 뜬다.
const PATH =
