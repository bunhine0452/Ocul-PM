...
export function CommandPalette({
  ...
  return (
    <div
      data-home-overlay
      className="scrim z-command flex items-start justify-center pt-[18vh] p-4 animate-in fade-in duration-(--dur-2)"
      onClick={(e) => {
    ...
    >
      <Command
        ...
        className="w-full max-w-xl bg-card border border-border rounded-xl shadow-xl overflow-hidden flex flex-col animate-in zoom-in-95 duration-(--dur-2)"
        ...
        <Command.List className="max-h-[60vh] overflow-y-auto scrollbar-thin p-1">
          ...
          {entityHits.length > 0 ? (
            <Command.Group
              ...
              className="[&_[cmdk-group-heading]]:px-3 [&_[cmdk-group-heading]]:py-1.5 [&_[cmdk-group-heading]]:text-fs-1 [&_[cmdk-group-heading]]:uppercase [&_[cmdk-group-heading]]:tracking-wider [&_[cmdk-group-heading]]:text-muted-foreground"
            >
              {entityHits.map((hit) => {
                ...
                return (
                  ...
                  >
                    <Icon  className="text-muted-foreground" size={15} />
                    <span className="flex-1 truncate">{hit.title}</span>
                    <span className="text-fs-1 text-muted-foreground shrink-0">
                      {hit.subtitle}
                    </span>
                  </Command.Item>
                );
          ...
          {symbolHits.length > 0 ? (
            ...
            >
              {symbolHits.map((sym, i) => (
                ...
                >
                  <Code2  className="text-muted-foreground" size={15} />
                  ...
                  <span className="text-fs-1 text-muted-foreground shrink-0 truncate max-w-[45%]">
              ...
              {list.map((it) => {
                ...
                return (
                  ...
                  >
                    ...
                    {it.shortcut && (
                      <kbd className="text-fs-1 text-muted-foreground font-mono">
                        {it.shortcut}
                      </kbd>
                    )}
                  </Command.Item>
