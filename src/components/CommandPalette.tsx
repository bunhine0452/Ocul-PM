...
export function CommandPalette({
  ...
  const items: CommandItem[] = useMemo(
    () => [
      ...
      { id: "code-chat",     label: "Code — Chat", alias: "채팅",
        group: "Code 화면", icon: MessageSquare,   onSelect: goCode("chat") },
      { id: "code-assist",   label: "Code — Assist", alias: "어시스트 quick edit",
        group: "Code 화면", icon: Sparkles,        onSelect: goCode("assist") },
